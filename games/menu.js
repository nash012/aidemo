...
module.exports = {
  create: function (ctx, W, H, onSelect) {
    // 三款游戏配置
    var games = [
      { key: "jump",     title: "跳一跳",       desc: "按住蓄力，松开跳跃",     icon: "🏃", color: "#6d5bd0", colorLite: "#8270e0" },
      { key: "laser",    title: "激光镭射象棋", desc: "策略对战，激光反射",     icon: "⚡", color: "#ff5a6e", colorLite: "#ff8a5a" },
      { key: "pigmerge", title: "萌宠合成",     desc: "同级合成，挑战高分",     icon: "🐾", color: "#1a9f6e", colorLite: "#36d399" }
    ];
